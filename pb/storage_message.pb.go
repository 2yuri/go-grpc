...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=grpc.Storage_Driver" json:"driver,omitempty"`
...
var file_proto_storage_message_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x76, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x67, 0x72,
	...
	0x6f, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x67, 0x72, 0x70, 0x63,
	...
	0x07, 0x0a, 0x03, 0x53, 0x53, 0x44, 0x10, 0x02, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x70, 0x62, 0x62,
...
var file_proto_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: grpc.Storage.Driver
	(*Storage)(nil),     // 1: grpc.Storage
	(*Memory)(nil),      // 2: grpc.Memory
}
var file_proto_storage_message_proto_depIdxs = []int32{
	0, // 0: grpc.Storage.driver:type_name -> grpc.Storage.Driver
	2, // 1: grpc.Storage.memory:type_name -> grpc.Memory
