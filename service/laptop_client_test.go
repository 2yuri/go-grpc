...
func TestClientSearchLaptop(t *testing.T) {
	...
	for i := 0; i < 6; i++ {
		...
		case 4:
			...
			laptop.Ram = &pb.Memory{Value: 16, Unit: pb.Memory_GIGAYTE}
		...
		case 5:
			...
			laptop.Ram = &pb.Memory{Value: 64, Unit: pb.Memory_GIGAYTE}
			expectedIDs[laptop.Id] = true
		}
